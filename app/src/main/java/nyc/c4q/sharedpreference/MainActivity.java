package nyc.c4q.sharedpreference;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login=getApplication().getSharedPreferences("sharedPrefsTesting",MODE_PRIVATE);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkBox.isChecked()) {
                   ...
                   //when you wan to store data immediately .commit
                    //when you want to store data in mean time .apply
                    editor.commit();
                } else {
                    editor.putBoolean("isChecked", checkBox.isChecked());
                    editor.commit();
                ...
                if (username.getText().toString().equalsIgnoreCase(login.getString(checkUser, null))
                    ...
                    Toast t = Toast.makeText(getApplicationContext(), "Username or password Incorrect - please Try again", Toast.LENGTH_LONG);
                }
            }
        });
